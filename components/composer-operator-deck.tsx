      ...
      () => [
        {
          ...
          keywords: 'paste parser smart ingest import',
          action: () => jumpTo('ingest'),
        },
        {
          id: 'jump-identity',
          label: 'Jump to Incident Identity',
          detail: 'Region, ticket, and incident headline.',
          keywords: 'region ticket identity summary',
          action: () => jumpTo('identity'),
        },
        {
          id: 'jump-dispatch',
          label: 'Jump to Dispatch Context',
          detail: 'Timing, PIC, topology, root cause, and cut point.',
          keywords: 'dispatch pic topology rootcause cut point',
          action: () => jumpTo('dispatch'),
        },
        {
          id: 'jump-progress',
          ...
          action: () => jumpTo('progress'),
        },
        {
          id: 'jump-closure',
          label: 'Jump to Closure Readiness',
          detail: 'Complete administrative closure tasks.',
          keywords: 'closure matoa wag rfo email',
          action: () => jumpTo('closure'),
        },
        {
          id: 'copy-report',
          label: 'Copy formatted report',
          detail: 'Copy the current WAG-ready incident output.',
          keywords: 'copy report wag output clipboard',
          action: () => void copyReport(),
        },
        {
          id: 'new-draft',
          label: 'Create blank draft',
          detail: 'Preserve the current incident and open a clean draft.',
          keywords: 'new blank incident draft',
          action: createBlankDraft,
        },
        {
          id: 'clone-draft',
          label: 'Clone current incident',
          detail: 'Create a separate exact copy of the current incident.',
          keywords: 'duplicate clone copy incident',
          action: cloneCurrentDraft,
        },
        {
          id: 'templates',
          label: 'Open template library',
          detail: 'Save or reuse Cloudflare-backed Composer templates.',
          keywords: 'template library cloud d1 reusable',
          action: () => {
            setOpen(true);
            setTab('templates');
            setPaletteOpen(false);
        ...
        },
        {
          ...
          detail: 'Switch to the live incident command center.',
          keywords: 'operations command center running',
          action: () =>
            navigateWorkspace(
              'operations'
            ),
        },
        {
          ...
          detail: 'Search or reopen saved incident memory.',
          keywords: 'archive vault history incident',
          action: () =>
            navigateWorkspace(
              'archive'
            ),
      ...
      >
        ...
        <span className={styles.launcherCopy}>
          ...
          <small>
            {issueCount === 0
              ? 'Ready · Ctrl K'
              : `${issueCount} signal${issueCount === 1 ? '' : 's'} · Ctrl K`}
          </small>
        </span>
        <ChevronRight
          className={
                ...
                issueCount === 0 ? (
                  <div className={styles.readyState}>
                    ...
                    <span>
                      ...
                      <small>
                        Core report fields and closure state are ready for final review.
                      </small>
                    </span>
                  </div>
                ) : (
              ...
              <div className={styles.templateList}>
                {templates.length === 0 ? (
                  <div className={styles.emptyTemplateState}>
                    ...
                    <small>
                      Save the current incident structure once, then reuse it as a clean draft or exact clone.
                    </small>
                  </div>
                ) : (
                  templates.map(
